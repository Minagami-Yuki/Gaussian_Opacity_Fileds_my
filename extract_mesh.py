...
def marching_tetrahedra_with_binary_search(model_path, name, iteration, views, gaussians, pipeline, background, kernel_size, filter_mesh : bool, texture_mesh : bool):
    ...
    for step in range(n_binary_steps):
        ...
        # # 分块构建mesh
        # from trimesh.repair import remove_duplicate_faces, fill_holes
        ...
        # # 简化网格
        # mesh = simplify_quadratic_decimation(mesh, target_faces=100000)  # Adjust target_faces as needed
        ...
        # mesh.export(render_path/mesh_binary_search_7.ply, file_type='ply', encoding='binary')
